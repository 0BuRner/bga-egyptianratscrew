...
-- Example 1: create a standard "card" table to be used with the "Deck" tools (see example game "egyptianratscrew"):
...
ALTER TABLE `player` ADD `slap_time` BIGINT DEFAULT NULL;
